...
public:
    QStabilizer(const bitCapInt& perm, const bitLenInt& qubitCount, bool useHardwareRng = true,
...
#define IS_ARG_PI(c) IS_OPPOSITE(c, ONE_CMPLX)
    ...
    public:
        ...
        {
            RemoveBuffer(p, targetOfShards, &QEngineShard::GetControlsShards);
        }
    ...
    public:
        ...
        {
            AddBuffer(p, targetOfShards, &QEngineShard::GetControlsShards);
        }
    ...
    public:
        ...
        virtual void POWModNOut(
            bitCapInt base, bitCapInt modN, bitLenInt inStart, bitLenInt outStart, bitLenInt length);
        virtual void CMUL(bitCapInt toMul, bitLenInt inOutStart, bitLenInt carryStart, bitLenInt length,
            bitLenInt* controls, bitLenInt controlLen);
        virtual void CDIV(bitCapInt toDiv, bitLenInt inOutStart, bitLenInt carryStart, bitLenInt length,
            bitLenInt* controls, bitLenInt controlLen);
        virtual void CMULModNOut(bitCapInt toMul, bitCapInt modN, bitLenInt inStart, bitLenInt outStart,
            bitLenInt length, bitLenInt* controls, bitLenInt controlLen);
        virtual void CIMULModNOut(bitCapInt toMul, bitCapInt modN, bitLenInt inStart, bitLenInt outStart,
            bitLenInt length, bitLenInt* controls, bitLenInt controlLen);
        virtual void CPOWModNOut(bitCapInt base, bitCapInt modN, bitLenInt inStart, bitLenInt outStart,
            bitLenInt length, bitLenInt* controls, bitLenInt controlLen);
    ...
    protected:
        ...
        bool INTSCOptimize(bitCapInt toMod, bitLenInt start, bitLenInt length, bool isAdd, bitLenInt carryIndex,
        ...
        virtual QInterfacePtr EntangleRange(bitLenInt start, bitLenInt length, bitLenInt start2, bitLenInt length2,
            bitLenInt start3, bitLenInt length3);
        ...
        void ApplyBuffer(
            PhaseShardPtr phaseShard, const bitLenInt& control, const bitLenInt& target, const bool& isAnti);
