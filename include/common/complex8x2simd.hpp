...
struct Complex8x2Simd {
    ...
    {
        return _mm_add_ps(
            _mm_mul_ps(_mm_shuffle_ps(_val2, _val2, 177), _mm_xor_ps(SIGNMASK, _mm_shuffle_ps(other._val2, other._val2, 245))),
...
{
    return _mm_shuffle_ps(cmplx2._val2, cmplx2._val2, 68);
}
inline Complex8x2Simd dupeHi(const Complex8x2Simd& cmplx2)
{
    return _mm_shuffle_ps(cmplx2._val2, cmplx2._val2, 238);
}
    ...
    const Complex8x2Simd& mtrxCol1, const Complex8x2Simd& mtrxCol2, const Complex8x2Simd& qubit)
{
    ...
    return _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(mtrxCol1._val2, mtrxCol1._val2, 177), _mm_xor_ps(SIGNMASK, _mm_shuffle_ps(dupeLo, dupeLo, 245))), _mm_mul_ps(mtrxCol1._val2, _mm_shuffle_ps(dupeLo, dupeLo, 160))), _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(mtrxCol2._val2, mtrxCol2._val2, 177), _mm_xor_ps(SIGNMASK, _mm_shuffle_ps(dupeHi, dupeHi, 245))), _mm_mul_ps(mtrxCol2._val2, _mm_shuffle_ps(dupeHi, dupeHi, 160))));
}
inline Complex8x2Simd matrixMul(
    const float& nrm, const Complex8x2Simd& mtrxCol1, const Complex8x2Simd& mtrxCol2, const Complex8x2Simd& qubit)
{
    __m128 dupeLo = _mm_shuffle_ps(qubit._val2, qubit._val2, 68);
    __m128 dupeHi = _mm_shuffle_ps(qubit._val2, qubit._val2, 238);
    return _mm_mul_ps(_mm_set1_ps(nrm), _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(mtrxCol1._val2, mtrxCol1._val2, 177), _mm_xor_ps(SIGNMASK, _mm_shuffle_ps(dupeLo, dupeLo, 245))), _mm_mul_ps(mtrxCol1._val2, _mm_shuffle_ps(dupeLo, dupeLo, 160))), _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(mtrxCol2._val2, mtrxCol2._val2, 177), _mm_xor_ps(SIGNMASK, _mm_shuffle_ps(dupeHi, dupeHi, 245))), _mm_mul_ps(mtrxCol2._val2, _mm_shuffle_ps(dupeHi, dupeHi, 160)))));
}
