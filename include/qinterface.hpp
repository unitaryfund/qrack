...
public:
     ...
     */
    virtual bool M(bitLenInt qubitIndex) { return false; };
    ...
    virtual bitCapInt MReg(bitLenInt start, bitLenInt length) { return 0; };
     ...
     */
    virtual double Prob(bitLenInt qubitIndex) { return 0.0; };
