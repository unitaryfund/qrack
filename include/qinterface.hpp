...
protected:
    ...
    virtual void ApplyControlled2x2(bitLenInt* controls, const bitLenInt &controlLen, const bitLenInt &target, const complex* mtrx, bool doCalcNorm);
    virtual void ApplyControlled2x2(bitLenInt control, bitLenInt target, const complex* mtrx, bool doCalcNorm);
    virtual void ApplyAntiControlled2x2(bitLenInt* controls, const bitLenInt &controlLen, const bitLenInt &target, const complex* mtrx, bool doCalcNorm);
...
public:
     ...
     * set to true.
     */
    virtual void ApplyControlledSingleBit(bitLenInt* controls, bitLenInt controlLen, const complex* mtrx, bitLenInt qubitIndex);
