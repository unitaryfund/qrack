...
add_executable (shors
    examples/shors.cpp
    )

set_target_properties(shors PROPERTIES RUNTIME_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/examples")

target_link_libraries (shors ${QRACK_LIBS})
...
target_compile_options (shors PUBLIC ${TEST_COMPILE_OPTS} -DCATCH_CONFIG_FAST_COMPILE)
