add_executable (quantum_associative_memory
    ${CMAKE_CURRENT_BINARY_DIR}/examples/quantum_associative_memory.cpp
    )
...
add_executable (teleport
    ${CMAKE_CURRENT_BINARY_DIR}/examples/teleport.cpp
    )
...
add_executable (qneuron_classification
    ${CMAKE_CURRENT_BINARY_DIR}/examples/qneuron_classification.cpp
    )
...
add_executable (cosmology
    ${CMAKE_CURRENT_BINARY_DIR}/examples/cosmology.cpp
    )
...
add_executable (grovers
    ${CMAKE_CURRENT_BINARY_DIR}/examples/grovers.cpp
    )
...
add_executable (grovers_lookup
    ${CMAKE_CURRENT_BINARY_DIR}/examples/grovers_lookup.cpp
    )
...
add_executable (ordered_list_search
    ${CMAKE_CURRENT_BINARY_DIR}/examples/ordered_list_search.cpp
    )
...
add_executable (shors_factoring
    ${CMAKE_CURRENT_BINARY_DIR}/examples/shors_factoring.cpp
    )
...
add_executable (pearson32
    ${CMAKE_CURRENT_BINARY_DIR}/examples/pearson32.cpp
    )
...
add_executable (quantum_perceptron
    ${CMAKE_CURRENT_BINARY_DIR}/examples/quantum_perceptron.cpp
    )
