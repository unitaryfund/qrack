...
if (ENABLE_OPENCL)
    ...
    target_link_libraries (pearson32 ${OpenCL_LIBRARIES})
    target_link_libraries (teleport ${OpenCL_LIBRARIES})
    target_link_libraries (qneuron_classification ${OpenCL_LIBRARIES})
