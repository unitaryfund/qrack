...
if (ENABLE_OPENCL)
    ...
    if (OPENCL_V3)
        ...
        target_compile_definitions (qrack_pinvoke PUBLIC CL_HPP_TARGET_OPENCL_VERSION=300)
    ...
    if (ENABLE_EXAMPLES AND NOT ENABLE_EMIT_LLVM)
        ...
        target_link_directories (cosmology PRIVATE ${QRACK_OpenCL_LINK_DIRS})
        if (ENABLE_ALU)
    ...
    if (NOT ENABLE_EMIT_LLVM)
        ...
        if (ENABLE_EXAMPLES)
            ...
            target_link_libraries (cosmology ${QRACK_OpenCL_LIBRARIES})
            if (ENABLE_ALU)
