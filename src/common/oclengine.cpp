...
const std::vector<OCLKernelHandle> OCLEngine::kernelHandles = {
    ...
    OCLKernelHandle(OCL_API_APPLY2X2_UNIT_SINGLE, "apply2x2unitsingle"),
    OCLKernelHandle(OCL_API_APPLY2X2_NORM_SINGLE, "apply2x2normsingle"),
    OCLKernelHandle(OCL_API_APPLY2X2_DOUBLE, "apply2x2double"),
    OCLKernelHandle(OCL_API_APPLY2X2_UNIT_DOUBLE, "apply2x2unitdouble"),
    OCLKernelHandle(OCL_API_APPLY2X2_NORM_DOUBLE, "apply2x2normdouble"),
    OCLKernelHandle(OCL_API_APPLY2X2_WIDE, "apply2x2wide"),
    OCLKernelHandle(OCL_API_APPLY2X2_UNIT_WIDE, "apply2x2unitwide"),
    OCLKernelHandle(OCL_API_APPLY2X2_NORM_WIDE, "apply2x2normwide"),
    OCLKernelHandle(OCL_API_APPLY2X2_SINGLE_WIDE, "apply2x2singlewide"),
    OCLKernelHandle(OCL_API_APPLY2X2_UNIT_SINGLE_WIDE, "apply2x2unitsinglewide"),
    ...
    OCLKernelHandle(OCL_API_APPLY2X2_UNIT_DOUBLE_WIDE, "apply2x2unitdoublewide"),
    OCLKernelHandle(OCL_API_APPLY2X2_NORM_DOUBLE_WIDE, "apply2x2normdoublewide"),
