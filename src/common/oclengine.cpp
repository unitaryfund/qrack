...
const std::vector<OCLKernelHandle> OCLEngine::kernelHandles = {
    ...
    OCLKernelHandle(OCL_API_APPLY2X2_SINGLE, "apply2x2double"),
    OCLKernelHandle(OCL_API_APPLY2X2_UNIT_SINGLE, "apply2x2unitdouble"),
    OCLKernelHandle(OCL_API_APPLY2X2_NORM_SINGLE, "apply2x2normdouble"),
