...
void QEngineOCLMulti::SingleBitGate(
    bitLenInt cntrlDepth, bool anti, bool doNormalize, bitLenInt bit, F fn, Args... gfnArgs)
{
...
bitLenInt QEngineOCLMulti::SeparateMetaCNOT(bool anti, std::vector<bitLenInt> controls, bitLenInt target, bitLenInt length) {
    bitLenInt i;
