...
public:
    ...
    /// "Anti-doubly-controlled not" - Apply "not" if control bits are both zero, do not apply if either control bit is
    /// one.
    ...
    /** Dyadic fraction "phase shift gate" - Rotates as e^(i*(M_PI * numerator) / denominator) around |1> state. NOTE
     * THAT DYADIC OPERATION ANGLE SIGN IS REVERSED FROM RADIAN ROTATION OPERATORS AND LACKS DIVISION BY A FACTOR OF
     * TWO. */
    ...
    /// Controlled dyadic fraction x axis rotation gate - if control bit is true, rotates as e^(i*(M_PI * numerator) /
    /// denominator) around Pauli x axis
    /** Controlled dyadic fraction x axis rotation gate - if control bit is true, rotates as e^(i*(M_PI * numerator) /
     * denominator) around Pauli x axis. NOTE THAT DYADIC OPERATION ANGLE SIGN IS REVERSED FROM RADIAN ROTATION
     * OPERATORS. */
    ...
    /// Controlled dyadic fraction y axis rotation gate - if control bit is true, rotates as e^(i*(M_PI * numerator) /
    /// denominator) around Pauli y axis
    /** Controlled dyadic fraction y axis rotation gate - if control bit is true, rotates as e^(i*(M_PI * numerator) /
     * denominator) around Pauli y axis. NOTE THAT DYADIC OPERATION ANGLE SIGN IS REVERSED FROM RADIAN ROTATION
     * OPERATORS. */
    ...
    /// Controlled dyadic fraction z axis rotation gate - if control bit is true, rotates as e^(i*(M_PI * numerator) /
    /// denominator) around Pauli z axis
    /** Controlled dyadic fraction z axis rotation gate - if control bit is true, rotates as e^(i*(M_PI * numerator) /
     * denominator) around Pauli z axis. NOTE THAT DYADIC OPERATION ANGLE SIGN IS REVERSED FROM RADIAN ROTATION
     * OPERATORS. */
    ...
    /** Dyadic fraction "phase shift gate" - Rotates each bit as e^(i*(M_PI * numerator) / denominator) around |1>
     * state. NOTE THAT DYADIC OPERATION ANGLE SIGN IS REVERSED FROM RADIAN ROTATION OPERATORS AND LACKS DIVISION BY A
     * FACTOR OF TWO. */
    ...
    /// axis
    /** Dyadic fraction x axis rotation gate - Rotates each bit as e^(i*(M_PI * numerator) / denominator) around Pauli x
     * axis. NOTE THAT DYADIC OPERATION ANGLE SIGN IS REVERSED FROM RADIAN ROTATION OPERATORS AND LACKS DIVISION BY A
     * FACTOR OF TWO. */
    ...
    /// Dyadic fraction z axis rotation gate - Rotates each bit as e^(i*(M_PI * numerator) / denominator) around Pauli z
    /// axis
    /** Dyadic fraction z axis rotation gate - Rotates each bit as e^(i*(M_PI * numerator) / denominator) around Pauli z
     * axis. NOTE THAT DYADIC OPERATION ANGLE SIGN IS REVERSED FROM RADIAN ROTATION OPERATORS AND LACKS DIVISION BY A
     * FACTOR OF TWO. */
    ...
    /// Controlled "phase shift gate"
    /** Controlled "phase shift gate" - for each bit, if control bit is true, rotates target bit as e^(-i*\theta/2)
     * around |1> state */
    ...
    /// Controlled x axis rotation
    /** Controlled x axis rotation - for each bit, if control bit is true, rotates as e^(-i*\theta/2) around Pauli x
     * axis */
     ...
     * e^(i*(M_PI * numerator) / denominator) around Pauli x axis. NOTE THAT DYADIC OPERATION ANGLE SIGN IS REVERSED
     * FROM RADIAN ROTATION OPERATORS. */
    ...
    /** Controlled dyadic fraction y axis rotation gate - for each bit, if control bit is true, rotates target bit as
     * e^(i*(M_PI * numerator) / denominator) around Pauli y axis. NOTE THAT DYADIC OPERATION ANGLE SIGN IS REVERSED
     * FROM RADIAN ROTATION OPERATORS. */
    ...
    /** Controlled dyadic fraction z axis rotation gate - for each bit, if control bit is true, rotates target bit as
     * e^(i*(M_PI * numerator) / denominator) around Pauli z axis. NOTE THAT DYADIC OPERATION ANGLE SIGN IS REVERSED
     * FROM RADIAN ROTATION OPERATORS. */
     ...
     * to an unsigned format, with the sign bit assumed to be set at the appropriate position before the cast. */
