...
int main(int argc, char* argv[])
{
    ...
    for (bitLenInt i = 0U; i < halfWidth; ++i) {
        ...
        Qrack::QInterfacePtr qsim =
            Qrack::CreateQuantumInterface({ Qrack::QINTERFACE_QUNIT, Qrack::QINTERFACE_BDT }, width, Qrack::ZERO_BCI);
        Qrack::QInterfacePtr qsim_b = Qrack::CreateQuantumInterface(
            { Qrack::QINTERFACE_QUNIT, Qrack::QINTERFACE_BDT }, width - subsystemSize, Qrack::ZERO_BCI);
        ...
        if (result) {
            qsim = Qrack::CreateQuantumInterface(
                { Qrack::QINTERFACE_QUNIT, Qrack::QINTERFACE_BDT }, width, Qrack::ZERO_BCI);
            ghz(qsim);
        }
        ...
        cout << "QUnit with QBDD, " << (int)width << " qubits, " << (int)subsystemSize
             << " qubit subsystem, nonseparable: " << duration << " seconds, " << (result ? "failure." : "success.")
             << endl;

        qsim = Qrack::CreateQuantumInterface(
            { Qrack::QINTERFACE_QUNIT, Qrack::QINTERFACE_BDT }, subsystemSize, Qrack::ZERO_BCI);
